...
internal class InitialData
{
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            ...
            var payment1 = Payment.Of("mehmet", "5555555555554444", "12/28", "355", PaymentMethod.CreditCard);
            var payment2 = Payment.Of("john", "8885555555554444", "06/30", "222", PaymentMethod.EWallet);
